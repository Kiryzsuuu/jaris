  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} style={{ maxWidth: 720 }}>
                ...
                {suggestion.category ? (
                  <>
                    ...
                    <button
                      ...
                      style={{ border: "1px solid var(--brand-forest-medium)", color: "var(--brand-forest-medium)", background: "white" }}
                    >
                      Gunakan
                    </button>
                  </>
                ) : (
                  <span style={{ color: "var(--sys-orange)" }}>{suggestion.reasoning ?? "AI tidak memberikan saran"}</span>
                )}
              </div>
            )}
          </div>
        ...
        <div className="card mb-4">
          <h2 className="card-title mb-3">Data Korban / Penerima Santunan</h2>
